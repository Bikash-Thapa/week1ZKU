...
snarkjs zkey contribute Multiplier3Groth16/circuit_0000.zkey Multiplier3Groth16/circuit_final.zkey --name="Bikash Thapa" -v -e="First compile script written by me"
